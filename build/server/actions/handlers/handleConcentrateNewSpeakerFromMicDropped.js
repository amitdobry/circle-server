...
exports.handleConcentrateNewSpeakerFromMicDropped = handleConcentrateNewSpeakerFromMicDropped;
const panelConfigService_1 = require("../../panelConfigService");
function handleConcentrateNewSpeakerFromMicDropped(payload, context) {
    const { name } = payload;
