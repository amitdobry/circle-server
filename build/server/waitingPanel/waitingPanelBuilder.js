    ...
    return [
        {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    type: "text",
                    content: "The circle will begin when more people arrive. You can share the link to invite others.",
                    size: "base",
                    align: "center",
                    style: "text-gray-600",
